 ...
 *<
    ...
    DESCRIPTION:  Defines a WebGL Insert Helper Class
...
#ifndef __WebGL_INS__H__
 
#define __WebGL_INS__H__
 
#define WebGL_INS_CLASS_ID1 0xACAD4567
#define WebGL_INS_CLASS_ID2 0x0

extern ClassDesc* GetWebGLInsDesc();

class WebGLInsCreateCallBack;

class WebGLInsObject: public HelperObject {			   
    friend class WebGLInsCreateCallBack;
    friend INT_PTR CALLBACK WebGLInsRollupDialogProc( HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam );
