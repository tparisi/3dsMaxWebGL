...
#define MAXVER_INTERNALNAME "WebGL\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "webgl.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "WebGL ThreeJS .JS file export (core plugin)\0"//should  be overidden on a per-dll level
